...
/**
 * Função`measureArrayPerformance` que recebe uma função e um array como argumentos.
 * A função `measureArrayPerformance` deve executar a função fornecida com o array fornecido como entrada e medir o tempo de execução.
 */
